...
|---|---|---|---|
| `ENTITY-v22-adpf-power-fix-20260723-release.apk` | **3.6.0** (current) | release-signed | 10 MB |
...
| File | Version | Build | Size |
|---|---|---|---|
| `ENTITY-Bench-v2.1.0-release.apk` | **2.1.0** (current) | release-signed | 9.9 MB |
